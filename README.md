...
This allows direct comparison of numerical error accumulation (as energy is conserved in isolated system, considering no nonconservative forces exist in the system).
